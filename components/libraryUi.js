...
export const surfaceBtn =
  "rounded-2xl border border-white/55 bg-white/55 text-sm font-medium text-gray-700 shadow-inner backdrop-blur-xl transition hover:bg-white/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600"
